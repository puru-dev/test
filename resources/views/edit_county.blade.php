     ...
     <div class="row">
        <div class="col-xs-8 col-sm-8 col-md-8">
            <div class="form-group">
                ...
                <input type="text" name="county_name" value="{{$county->county_name}}" class="form-control" placeholder="Name">
            </div>
        </div>
        <div class="col-xs-8 col-sm-8 col-md-8">
            <div class="form-group">
              ...
              <select class="form-control" id="sel2" name="state_initial">
                ...
                <option {{ ( $county->state_initial == $uData->state_initial) ? 'selected' : '' }}>{{$uData->state_initial}}</option>
                @endforeach
              </select>
            </div>
        </div>
        <div class="col-xs-8 col-sm-8 col-md-8">
            <div class="form-group">
              ...
              <select class="form-control" id="sel1" name="state_fullname">
                @foreach ($states as $uData1)
                <option {{ ( $county->state_fullname == $uData1->state_fullname) ? 'selected' : '' }}>{{$uData1->state_fullname}}</option>
                @endforeach
              </select>
            </div>
        </div>
